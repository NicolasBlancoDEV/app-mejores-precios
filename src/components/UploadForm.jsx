    ...
    >
      ...
      <form onSubmit={handleSubmit} className="max-w-md mx-auto bg-[#1F252A] p-6 rounded-lg shadow-md border-2 border-[#3A4450]">
        <div className="mb-4 relative">
          <label className="block text-[#FFFFFF] mb-2 text-center">Nombre del Producto</label>
          <input
            type="text"
            value={name}
            ...
            onBlur={handleBlur}
            className="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#3B82F6] bg-[#1F252A] text-[#FFFFFF] text-center"
            ...
            >
              {suggestions.map((suggestion, index) => (
                <li
                  ...
                  className="px-4 py-2 hover:bg-[#2D333B] cursor-pointer text-[#FFFFFF] text-center"
                >
                  {suggestion}
                </li>
              ))}
        ...
        <div className="mb-4">
          <label className="block text-[#FFFFFF] mb-2 text-center">Precio (ARS)</label>
          <input
            type="number"
            value={price}
        ...
        <div className="mb-4">
          <label className="block text-[#FFFFFF] mb-2 text-center">Tienda</label>
          <input
            type="text"
            value={store}
        ...
        <div className="mb-4">
          <label className="block text-[#FFFFFF] mb-2 text-center">Categoría</label>
          <select
            value={category}
